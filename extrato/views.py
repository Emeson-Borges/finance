...
def novo_valor(request):
  if request.method == 'GET':
    ...
    return render(request, "novo-valor.html", {'contas':contas, 'categorias':categorias})
    ...
    #TODO: processar a mensagem de acordo com o tipo (Entrada/Saída)
...
def exportar_pdf(request):
  ...
  return FileResponse(path_output, filename="extrato_financeiro.pdf")